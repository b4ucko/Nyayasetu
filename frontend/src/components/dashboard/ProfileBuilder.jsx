...
export default function ProfileBuilder() {
  ...
  return (
    <div className="p-6 glass dark:bg-slate-800/80 rounded-2xl shadow-xl w-full max-w-5xl mx-auto border dark:border-slate-700 transition-colors">
      ...
      <p className="text-slate-600 dark:text-slate-300 mb-6 transition-colors">Build your profile to get personalized scheme recommendations securely.</p>
      
      {errors.submit && (
        <div className="mb-4 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 p-3 rounded-xl flex items-center text-sm">
      ...
      {!isDigilockerVerified ? (
        <div className="h-full bg-blue-50 dark:bg-slate-900 border border-blue-100 dark:border-slate-700 p-4 rounded-xl flex flex-col justify-center items-center text-center sm:text-left sm:flex-row sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Instantly fetch your Aadhaar details securely via Setu Sandbox.</p>
          </div>
          <button 
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 mt-2">
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1 transition-colors">Annual Income (INR)</label>
          <input 
            type="number" 
            min="0"
            disabled={!isEditing}
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1 transition-colors">Occupation</label>
          <select 
            disabled={!isEditing}
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1 transition-colors">State</label>
          <select 
            disabled={!isEditing}
        ...
        <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1 transition-colors">Gender</label>
            <select 
              disabled={!isEditing}
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1 transition-colors">Marital Status</label>
            <select 
              disabled={!isEditing}
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1 transition-colors">Caste / Category</label>
            <select 
              disabled={!isEditing}
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1 transition-colors">Disability Status</label>
            <select 
              disabled={!isEditing}
        ...
        <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1 transition-colors">Highest Education Level</label>
            <select 
              disabled={!isEditing}
